      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className={`absolute right-0 mt-2 w-56 ${darkMode ? "bg-gray-700" : "bg-white"} rounded-xl shadow-lg py-2 z-50`}>
                <Link
                  to="/profile"
                  className={`block px-4 py-3 ${darkMode ? "text-white hover:bg-gray-600" : "text-gray-800 hover:bg-gray-50"} transition-colors`}
                  onClick={() => setDropdownOpen(false)}
                >
                  <div className="flex items-center space-x-3">
                    <div className={`w-10 h-10 rounded-full ${darkMode ? "bg-gradient-to-br from-green-500 to-emerald-600" : "bg-gradient-to-br from-green-400 to-emerald-500"} flex items-center justify-center`}>
                    ...
                    <div>
                      ...
                      <p className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-500"}`}>Kelola akun Anda</p>
                    </div>
                  </div>
                </Link>
                <Link
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`w-10 h-10 rounded-full ${darkMode ? "bg-gradient-to-br from-purple-500 to-pink-600" : "bg-gradient-to-br from-purple-400 to-pink-500"} flex items-center justify-center`}>
                      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                      </svg>
                    </div>
                    <div>
                      <span className="font-medium">Tracker Amal</span>
                      <p className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-500"}`}>Pantau ibadah harian</p>
                    </div>
                  </div>
                </Link>
